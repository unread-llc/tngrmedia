                ...
                handler: function(_, item) {
                    ...
                    if (type === 'image' || source.match(/\.(jp(e)?g|png|gif|svg)($|\?)/i)) {
                        ...
                        var setIframe = function (width$$1, height$$1) {
                            ...
                            return this$1.setItem(item, getIframe(("https://web.archive.org/web/20220124054123/https://www.youtube" + (matches$$1[1] || '') + ".com/embed/" + id), width$$1, height$$1, this$1.videoAutoplay));
                        };

                        getImage(("https://web.archive.org/web/20220124054123/https://img.youtube.com/vi/" + id + "/maxresdefault.jpg")).then(
                            function (ref) {
                                var width$$1 = ref.width;
                                var height$$1 = ref.height;
                                ...
                                if (width$$1 === 120 && height$$1 === 90) {
                                    getImage(("https://web.archive.org/web/20220124054123/https://img.youtube.com/vi/" + id + "/0.jpg")).then(
                                        function (ref) {
                                            var width$$1 = ref.width;
                                            var height$$1 = ref.height;
                        ...
                        ajax(("https://web.archive.org/web/20220124054123/https://vimeo.com/api/oembed.json?maxwidth=1920&url=" + (encodeURI(source))), {responseType: 'json', withCredentials: false})
                            .then(
                                function (ref) {
                                    ...
                                    return this$1.setItem(item, getIframe(("https://web.archive.org/web/20220124054123/https://player.vimeo.com/video/" + (matches$$1[2])), width$$1, height$$1, this$1.videoAutoplay));
                        },
                                function () { return this$1.setError(item); }
                            );
...
/*
     FILE ARCHIVED ON 05:41:23 Jan 24, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 02:10:27 Apr 13, 2025.
...
playback timings (ms):
  ...
  esindex: 0.014
  cdx.remote: 8.984
  LoadShardBlock: 54.029 (3)
  PetaboxLoader3.datanode: 104.662 (5)
  load_resource: 1231.487
  PetaboxLoader3.resolve: 1122.691
  loaddict: 46.449
*/